							...
							<div class="col-md-4 text-center">
								<div class="product-entry">
									<div class="product-img" style="background-image: url(<?php echo base_url('assets/images/item-5.jpg') ?>) ;">
										...
										<div class="cart">
											<p>
												<span class="addtocart"><a href="<?php echo base_url('index/cart') ?>"><i class="icon-shopping-cart"></i></a></span> 
												<span><a href="index/product_detail"><i class="icon-eye"></i></a></span> 
												<span><a href="<?php echo base_url('index/wishlist') ?>"><i class="icon-heart3"></i></a></span>
												
											</p>
										</div>
									</div>
									<div class="desc">
										<h3><a href="<?php echo base_url('index/product_detail') ?>">Floral Dress</a></h3>
