			   		...
			   		<div class="container-fluid">
			   			<div class="row">
				   			<div class="col-md-6 col-md-offset-3 col-sm-12 col-xs-12 slider-text">
				   				<div class="slider-text-inner text-center"> <!-- pune pe vertical -->
				   					<h1>About Us</h1>
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="row row-pb-sm">
										<div class="col-md-6">
											<img class="img-responsive" src="<?php echo base_url('assets/images/about.jpg')?>" alt=""> <!-- creaza o imagine responsive -->
										</div>
										<div class="col-md-6">
